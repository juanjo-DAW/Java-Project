...
public class Pajaro extends Animal {
     ...
     * @param parasitos
     */
    public Pajaro(String habitat, String especie, String genero, String tiempoNavegacion, String horaLlegada, String viento, String nubosidad, String direcionViento, int embarcaciones, float size, boolean parasitos) {
