...
public class Mantarraya extends Animal{
     ...
     * @param venenosas
     */
    public Mantarraya(String habitat, String especie, String genero, String tiempoNavegacion, String horaLlegada, String viento, String nubosidad, String direcionViento, int embarcaciones, float size, String profundidad, boolean venenosas) {
